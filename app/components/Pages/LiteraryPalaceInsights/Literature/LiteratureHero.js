/**
 * Literature Hero Component
 * 
 * Hero section for Literature/Insights page
 * Features:
 * - Dark blue gradient background 
 * - Main heading with purple border outline
 * - Descriptive text
 * - Search bar for literature search
 * - Yellow/green book stack illustration
 * 
 * @component
 * @returns {JSX.Element} Literature hero section
 */
      ...
      <div className="relative z-10 pb-0 -mb-6 px-2 sm:px-4 lg:px-6">
        <div className="w-full flex justify-center">
          <div className="relative w-full max-w-6xl mx-auto">
            <input
              type="text"
              placeholder="Search Literature by authors, title and genres."
