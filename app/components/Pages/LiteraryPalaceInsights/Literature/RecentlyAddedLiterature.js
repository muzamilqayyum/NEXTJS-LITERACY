 ...
 * 
 * Displays grid of recently added literature content
 * Features:
 * - Section heading
 * - Grid layout (2 cols mobile, 4 cols desktop)
 * - Literature cards with titles
 * - Upgrade to Literery CTA card
 * 
 * @component
 * @returns {JSX.Element} Recently added literature section
 */
...
const RecentlyAddedLiterature = () => {
  // Sample literature data - replace with actual data
  const recentlyAdded = [
    { id: 1, title: "A Glimpse in the world of Literature A Glimpse in the..." },
    { id: 2, title: "A Glimpse in the world of Literature A Glimpse in the..." },
    { id: 3, title: "A Glimpse in the world of Literature A Glimpse in the..." },
    { id: 4, title: "A Glimpse in the world of Literature A Glimpse in the..." },
    { id: 5, title: "A Glimpse in the world of Literature A Glimpse in the..." },
    { id: 6, title: "A Glimpse in the world of Literature A Glimpse in the..." },
  ];
              ...
              {recentlyAdded.map((item) => (
                ...
                >
                    ...
                    <div className="flex-1 flex flex-col pl-6 relative pb-12">
                      {/* top tag */}
                      <div className="mb-2">
                        <span className="inline-block bg-[#b5d56a] text-[#07294e] text-xs font-semibold rounded-full px-3 py-1">Lit Guide</span>
                      </div>
                      ...
                      <p className="text-gray-500 text-sm leading-relaxed">A short summary to help you decide what to read next.</p>
          ...
          <div className="lg:col-span-3">
            ...
            >
              <div>
                ...
                <p className="text-sm text-gray-600 mb-2 text-center">Download clear Literature insights PDFs, summaries, themes, characters, quotes, and analysis for quick study.</p>
              ...
              <div className="text-center">
                <button 
                  className="bg-[#07294e] text-white px-6 py-2 rounded-lg font-medium hover:bg-[#0a3a6b] transition-colors cursor-pointer"
                >
                  Download
                </button>
              </div>
...
export default RecentlyAddedLiterature;
