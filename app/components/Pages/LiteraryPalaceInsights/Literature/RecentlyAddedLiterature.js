      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="w-full lg:col-span-3">
            <div className="relative bg-[#f4f4f4] border-2 border-[#b5d56a] p-6 flex flex-col justify-between min-h-[320px]">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-2 text-center">
                  Download clear Literature insights PDFs, summaries, themes, characters, quotes, and analysis for quick study.
                </p>
