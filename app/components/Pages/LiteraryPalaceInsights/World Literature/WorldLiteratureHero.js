/**
 * World Literature Hero Component
 * 
 * Hero section for World Literature page
 * Features:
 * - Dark blue gradient background
 * - Main heading with purple border outline
 * - Descriptive text
 * - Search bar for world literature search
 * - Icon illustration
 *
 * @component
 * @returns {JSX.Element} World Literature hero section
 */
      ...
      <div className="relative z-10 pb-0 -mb-6 px-2 sm:px-4 lg:px-6">
        <div className="w-full flex justify-center">
          <div className="relative w-full max-w-6xl mx-auto">
            <input
              type="text"
              placeholder="Search World Literature by authors, titles, and regions."
