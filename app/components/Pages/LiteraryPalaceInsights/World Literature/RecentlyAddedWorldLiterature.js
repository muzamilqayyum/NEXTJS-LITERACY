/**
 * Recently Added World Literature Section Component
 *
 * Displays grid of recently added world literature content
 * Features:
 * - Section heading
 * - Grid layout (2 cols mobile, 4 cols desktop)
 * - World literature cards with titles
 * - Upgrade to Literary CTA card
 *
 * @component
 * @returns {JSX.Element} Recently added world literature section
 */
...
const RecentlyAddedWorldLiterature = () => {
  // Sample world literature data - replace with actual data
  const recentlyAdded = [
    { id: 1, title: "A Glimpse in the world of World Literature..." },
    { id: 2, title: "A Glimpse in the world of World Literature..." },
    { id: 3, title: "A Glimpse in the world of World Literature..." },
    { id: 4, title: "A Glimpse in the world of World Literature..." },
    { id: 5, title: "A Glimpse in the world of World Literature..." },
    { id: 6, title: "A Glimpse in the world of World Literature..." },
  ];
    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-9 w-[800px] ml-0"> {/* Moved cards to the left side */}
              ...
              {recentlyAdded.map((item) => (
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col pl-6 relative pb-16">
                    {/* top tag */}
                    <div className="mb-2">
                      <span className="inline-block bg-[#b5d56a] text-[#07294e] text-xs font-semibold rounded-full px-3 py-1">World Literature</span>
                    </div>
          ...
          <div className="lg:col-span-3">
            ...
            >
              <div>
                ...
                <p className="text-sm text-gray-600 mb-2 text-center">Download clear World Literature PDFs, summaries, themes, characters, quotes, and analysis for quick study.</p>
...
export default RecentlyAddedWorldLiterature;